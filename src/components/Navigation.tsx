...
export function Navigation({ currentView, onViewChange }: NavigationProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 md:static md:bottom-auto">
      <div className="bg-card/95 backdrop-blur-lg border-t md:border-t-0 md:border-b border-border">
          ...
          <div className="flex items-center justify-around md:justify-start md:gap-2 py-2">
            {navItems.map(({ id, label, icon: Icon }) => (
              <Button
                ...
                className={cn(
                  "flex-col md:flex-row gap-1 h-auto py-2 px-4 md:px-6",
